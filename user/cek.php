...
<head>
    ...
    <title>Safety | Cek Data OPL</title>
...
<?php
            ...
            ?>
            <a href="dataopl.php" class="btn btn-dark btn-lg btn-block">Kembali</a>
            <embed type="application/pdf" src="<?php echo $row['berkas']; ?>" width="100%" height="700"></embed>
            <?php
                    }
                }
                    ?>
