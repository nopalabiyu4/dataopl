...
<head>
    ...
    <title>Safety | Proses Edit OPL</title>
...
<?php
     ...
     if ($ukuranFile > 0)
 {
  ...
  // query SQL untuk update data file
   ...
   mysqli_query($conn,"UPDATE dataopl 
             SET nama_mesin = '$nama_mesin', lokasi_id = '$lokasi_id', department_id = '$department_id', title = '$namaFile', size = '$ukuranFile', ekstensi = '$ekstensiFile', berkas = '$linkBerkas'
 ...
 else
 {
    ...
    mysqli_query($conn,"UPDATE dataopl SET nama_mesin = '$nama_mesin', lokasi_id = '$lokasi_id', department_id = '$department_id' WHERE idx = '$idx'");
 }
 ...
 $hasil = ($conn);
  //cek apakah berhasil
         if ($hasil){
                 ...
                 <meta http-equiv='refresh' content='1; url= dataopl.php'/>  ";
